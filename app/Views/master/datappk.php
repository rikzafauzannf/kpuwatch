            ...
            <table class="table table-sm dataTable w-100">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="fs-6">Diusulkan Sebagai</th>
                    </tr>
                </thead>
    ...
    <div class="modal-dialog modal-dialog-centered" style="width: 400px;">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5 fw-medium text-primary" id="exampleModalLabel">Tambah Data PPK</h1>
                    ...
                    <div class="row g-2 text-primary">
                        <div class="col-md-12">
                            <div class="input-group">
                                <span class="input-group-text" id="namaLengkap"><i class="bi bi-person"></i></span>
                                <input type="text" class="form-control" placeholder="Nama Lengkap" aria-label="namaLengkap" aria-describedby="namaLengkap">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="input-group">
                                <span class="input-group-text" id="NIP"><i class="bi bi-people"></i></span>
                                <input type="text" class="form-control" placeholder="NIP" aria-label="NIP" aria-describedby="NIP">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="input-group">
                                <span class="input-group-text" id="Pangkat"><i class="bi bi-people"></i></span>
                                <input type="text" class="form-control" placeholder="Pangkat / Golongan" aria-label="pg" aria-describedby="Pangkat">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="input-group">
                                <span class="input-group-text" id="nHP"><i class="bi bi-phone"></i></span>
                                <input type="text" class="form-control" placeholder="Nomor Handphone" aria-label="nHP" aria-describedby="nHP">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="input-group">
                                <span class="input-group-text" id="DSBg"><i class="bi bi-person-up"></i></span>
                                <input type="text" class="form-control" placeholder="Diusulkan Sebagai" aria-label="Diusulkan Sebagai" aria-describedby="DSBg">
                            </div>
                        </div>
